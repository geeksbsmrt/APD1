...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	[[UILabel appearance] setFont:[UIFont fontWithName:@"Orbitron-Regular" size:12]];

	[[UITextView appearance] setFont:[UIFont fontWithName:@"Orbitron-Regular" size:12]];

	[[UILabel appearanceWhenContainedIn:[UITextField class], nil] setTextColor:[UIColor blackColor]];
	
	[[UILabel appearanceWhenContainedIn:[UITableViewCell class], nil] setFont:[UIFont fontWithName:@"Orbitron-Bold" size:14]];
